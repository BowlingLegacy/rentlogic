...
urlpatterns = [
    ...
    path("rental-ready-pro/demo/reports/<slug:report_slug>/", views.rental_ledger_demo_report, name="rental_ledger_demo_report"),
    path("rental-ready-pro/<slug:page_slug>/", views.rental_ledger_product_page, name="rental_ledger_product_page"),
    path("rental-ledger-pro/", views.rental_ledger_pro_home, name="rental_ledger_pro_legacy_home"),
    path("rental-ledger-pro/contact/", views.rental_ledger_contact, name="rental_ledger_legacy_contact"),
    path("rental-ledger-pro/demo/", views.rental_ledger_demo, name="rental_ledger_legacy_demo"),
    path("rental-ledger-pro/demo/reports/<slug:report_slug>/", views.rental_ledger_demo_report, name="rental_ledger_legacy_demo_report"),
    path("rental-ledger-pro/<slug:page_slug>/", views.rental_ledger_product_page, name="rental_ledger_legacy_product_page"),
    ...
    path("landlord-dashboard/current-resident-roster/template/", views.current_resident_roster_template, name="current_resident_roster_template"),
